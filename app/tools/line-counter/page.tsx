...
const instructions = [
  "Paste your text",
  "Line count displays instantly",
  "See empty vs non-empty lines",
  "Useful for code statistics",
];

const tips = [
  "Blank lines are counted separately",
  "Good for measuring code size",
...
export default function LineCounterPage() {
  ...
  return (
    <ToolLayout
      title="Line Counter"
      description="Count lines in text or code."
