...
const instructions = [
  "Adjust sliders for shadow properties",
...
const tips = [
  "X-offset controls horizontal shadow",
  "Y-offset controls vertical shadow",
  "Blur affects softness",
  "Spread increases shadow size",
];
