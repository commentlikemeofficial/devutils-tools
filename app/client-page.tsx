...
const tools = [
  // Converters
  { name: "URL Encoder/Decoder", href: "/tools/url-encoderdecoder", icon: Globe, category: "converters", description: "Encode and decode URLs for safe web transmission", color: "bg-blue-500" },
  ...
  { name: "JWT Decoder", href: "/tools/jwt-decoder", icon: Key, category: "converters", description: "Decode JWT tokens to view payload", color: "bg-teal-500" },
  // Generators
  { name: "Password Generator", href: "/tools/password-generator", icon: Lock, category: "generators", description: "Generate secure random passwords", color: "bg-red-500" },
  ...
  // Formatters
  { name: "JSON Formatter", href: "/tools/json-formatter", icon: FileJson, category: "formatters", description: "Format and validate JSON", color: "bg-green-500" },
  ...
  // Utilities
  { name: "LinkedIn Counter", href: "/tools/linkedin-counter", icon: Linkedin, category: "utilities", description: "Count LinkedIn post characters", color: "bg-blue-700" },
  { name: "Token Counter", href: "/tools/token-counter", icon: Hash, category: "utilities", description: "Count AI tokens for GPT/Claude", color: "bg-purple-700" },
